...
(function($ , undefined) {
	...
	Ace_File_Input.prototype.apply_settings = function() {
		...
		if(this.settings.defaultImg != "") {		//有預設圖片顯示預設圖片
			this.$element.after('<span class="ace-file-container hide-placeholder selected"><span class="ace-file-name '+this.settings.thumbnail+'" data-title="'+this.settings.no_file+'" style="margin:0;text-align:center;"><img class="middle" src="'+this.settings.defaultImg+'" style="max-width:100%;padding:0;margin:0;"><i class=" ace-icon fa fa-picture-o file-image"></i></span></span>');
		} else {
